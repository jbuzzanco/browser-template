...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <!-- Button trigger modal -->\n        <button type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#updateModal\">\nEdit Your Quote?\n<span class=\"glyphicon glyphicon-pencil\"></span>\n</button>\n\n        <!-- Modal update -->\n        <div class=\"modal fade\" id=\"updateModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n        <span aria-hidden=\"true\">&times;</span>\n      </button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Edit Your Quote</h4>\n              </div>\n              <div class=\"modal-body\">\n\n                <form data-id=\""
	    + alias1(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-quote-form\" >\n                  <h2>Update Quote</h2>\n                  <input name=\"quote[quoteText]\" type=\"text\" placeholder=\"Quote\" value=\""
	    + alias1(((helper = (helper = helpers.quoteText || (depth0 != null ? depth0.quoteText : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"quoteText","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" onfocus=\"this.select();\">\n                  <input name=\"quote[author]\" type=\"text\" placeholder=\"Original Author\" value=\""
	    + alias1(((helper = (helper = helpers.author || (depth0 != null ? depth0.author : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"author","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" onfocus=\"this.select();\">\n\n                  <button type=\"submit\" data-toggle='modal-close' name=\"submit\" class=\"btn btn-inverse btn-info\" value=\"Update Quote\">Update</button>\n                </form>\n\n\n              </div>\n            </div>\n          </div>\n        </div>\n    </div>\n\n";
